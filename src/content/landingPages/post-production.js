...
export const postProductionPages = [
  {
    ...
    faqs: [
      ...
      { question: 'What does post-production cost?', answer: 'Per-project work typically starts around £450 for a social cutdown package and £1,800 for a corporate film with grade, sound and versioning. Monthly retainers start around £1,500 for a fixed block of hours. Scope drives the number, so we quote against the brief rather than publishing a rate card that fits nobody.' },
