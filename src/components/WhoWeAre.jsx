...
export default function WhoWeAre() {
  ...
  return (
    <div style={{ background: "#fff" }}>
      <Seo
        title="About Infynix | Growth Engineering Agency, London"
        description="Infynix operates from London with delivery teams in the UAE and India, engineering growth systems for UK and international businesses."
        path="/about"
        schema={[
          organizationSchema(),
          breadcrumbSchema([
      ...
      <section className="solutions-hero-section" style={{
        ...
        <div style={{ position: 'relative', zIndex: 1 }} data-aos="fade-up">
          <h1 style={{ fontFamily: 'var(--ix-font-display)', fontWeight: 600, fontSize: 'clamp(2.1rem, 4vw, 3.5rem)', color: '#111', lineHeight: 1.1, marginTop: '0', marginBottom: '1.5rem', letterSpacing: '-0.02em' }}>
          ...
          <p style={{ fontFamily: 'var(--ix-font-body)', fontSize: '1.05rem', color: '#333', lineHeight: 1.6, marginBottom: '1.5rem', maxWidth: '580px' }}>
            Infynix operates from our London office at 68 Endsleigh Gardens, Ilford, working directly with UK businesses on growth engineering, web development, and AI automation.
          </p>
