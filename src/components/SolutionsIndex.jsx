...
const SolutionsIndex = () => {
  ...
  const layers = [
    {
      ...
      desc: (
        <>
          Performance advertising, technical SEO, and <Link to="/solutions/infynix-agency" style={{ color: 'inherit', textDecoration: 'none' }}>paid media agency UK</Link> strategies built to capture high-intent buyers.
        </>
      ),
      img: capImg1,
      alt: "Performance marketing agency London",
      slug: "infynix-agency",
      services: [
    ...
    },
    {
      ...
      desc: (
        <>
          Cinematic brand films, modern <Link to="/solutions/infynix-media" style={{ color: 'inherit', textDecoration: 'none' }}>UI/UX design agency UK</Link> solutions, and 3D motion graphics that command market authority as a premier <Link to="/solutions/infynix-media" style={{ color: 'inherit', textDecoration: 'none' }}>branding agency London</Link>.
        </>
      ),
      img: capImg2,
      alt: "Branding and media production agency UK",
      slug: "infynix-media",
      services: [
    ...
    },
    {
      ...
      desc: (
        <>
          Custom software architectures from a leading <Link to="/solutions/infynix-growth-solutions" style={{ color: 'inherit', textDecoration: 'none' }}>web development company UK</Link>, autonomous AI agents, enterprise automation, and <Link to="/solutions/infynix-growth-solutions" style={{ color: 'inherit', textDecoration: 'none' }}>CRM integration services UK</Link>.
        </>
      ),
      img: capImg3,
      alt: "Web development and CRM integration UK",
  ...
  return (
    <div style={{ background: '#000', color: '#fff', minHeight: '100vh', fontFamily: 'var(--ix-font-body)' }}>
      <Seo
        title="Digital Agency Services in London | Infynix Solutions"
        description="Infynix delivers performance marketing, media production, and software development for UK businesses. Explore our three core service divisions."
        path="/solutions"
        ogType="website"
        schema={[
          organizationSchema(),
      ...
      <section style={{ padding: '80px 5%', textAlign: 'center', background: '#0a0a0a', borderBottom: '1px dashed #333' }}>
        <p style={{ fontSize: '1.2rem', color: '#ccc', maxWidth: '850px', margin: '0 auto 20px', lineHeight: 1.6 }}>
          Infynix delivers performance marketing, media production, and software development for <strong style={{ color: '#fff' }}>UK businesses</strong> across <Link to="/industries" style={{ color: '#00A880', textDecoration: 'none' }}>all major industries</Link>.
        </p>
      </section>
