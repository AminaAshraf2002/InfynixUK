...
const services = [
  {
    ...
    desc: 'Performance marketing agency for UK brands, built to put the finished system in front of the right people.',
  ...
  },
  {
    ...
    layerName: 'Content',
    desc: 'Media production for UK companies, built to fill the systems layer with something worth looking at.',
  ...
  },
  {
    ...
    layerName: 'Systems',
    desc: 'AI-native software for UK businesses, built to run everything above it in the stack.',
