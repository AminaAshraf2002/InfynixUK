...
const GrowthEngineering = () => {
  ...
  const whyTabsData = [
    ...
    },
    {
      ...
      details: "Performance marketing agency for UK brands, built to put the finished system in front of the right people with clear tracking and transparent reporting.",
    ...
    },
    {
      ...
      details: "Media production for UK companies, built to fill the systems layer with something worth looking at and build authority.",
      heading: "Visual identity and video production that builds credibility for UK and international businesses alike."
    },
    {
